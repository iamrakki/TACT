...
const ShareSocial = ({ open, setOpen, handleClickOpen, handleClose, pdfUrl }) => {
            ...
            >
                ...
                <DialogContent>
                    <div className="d-flex justify-content-center gap-2 mb-3 mt-2">
                        ...
                        <LinkedinShareButton url={`${pdfUrl}`} title={`Certificate`}>
                            <LinkedinIcon size={40} round={true} />
                        </LinkedinShareButton>
                        <EmailShareButton url={`${pdfUrl}`} subject={`Certificate`}>
